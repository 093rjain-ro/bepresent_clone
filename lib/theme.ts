...
export const ACCENT = '#1D9E75'           // Teal (focus/calm)
export const ACCENT_DIM = 'rgba(29, 158, 117, 0.12)'
export const ACCENT_BORDER = 'rgba(29, 158, 117, 0.30)'
export const ACCENT_GLOW = 'rgba(29, 158, 117, 0.20)'
export const ACCENT_LIGHT = '#E1F5EE'
...
// ── Semantic ──────────────────────────────────────────────────────────────────
export const ERROR = '#E24B4A' // CRITICAL (Red)
export const ERROR_DIM = 'rgba(226, 75, 74, 0.10)'
export const WARNING = '#BA7517' // Amber
export const SUCCESS = '#639922' // Green
export const REWARD = '#D85A30' // Coral
